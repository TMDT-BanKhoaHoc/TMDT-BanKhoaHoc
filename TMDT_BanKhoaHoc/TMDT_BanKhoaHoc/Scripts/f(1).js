...
for (var i = 0; i < s.length; i++) {
        if (s[i].nodeName == 'SCRIPT' &&
            s[i].attributes['src'] &&
            s[i].attributes['src'].nodeValue == unescape('\x2F\x2Fcse.google.com.vn\x2Fcoop\x2Fcse\x2Fbrand?form=cse-search-box\x26lang=vi')) {
          append = true;
          break;
        }
      }
    ...
    var b = function() {
      if (q.value == '') {
        ...
        q.placeholder = 'Tìm kiếm Tùy Chỉnh';
      }
    };
